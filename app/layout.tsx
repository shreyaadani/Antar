          ...
          <header className="sticky top-0 z-50 bg-white/60 border-b border-white/30 backdrop-blur-xl">
            <div className="max-w-4xl mx-auto px-5 py-4 flex items-center justify-between">
              ...
              <nav className="hidden sm:flex gap-7 text-sm text-[#696972]">
                <a href="/" className="hover:text-[#2B2B2F] transition">Home</a>
                <a href="/grounding" className="hover:text-[#2B2B2F] transition">Grounding</a>
                <a href="/actions" className="hover:text-[#2B2B2F] transition">Actions</a>
                <a href="/memories" className="hover:text-[#2B2B2F] transition">Memories</a>
                <a href="/identity" className="hover:text-[#2B2B2F] transition">Identity</a>
                <a href="/learn" className="hover:text-[#2B2B2F] transition">Learn</a>
              </nav>
            </div>
          </header>

          {/* Main content */}
          <main className="flex-1 max-w-4xl mx-auto px-5 py-10">
            {children}
          </main>
